...
//  Sample_CSP
//
//  Created by Mason Childers on 11/19/17.
...
public class StartScene : SKScene
{
    ...
    override public func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?)
    {
        ...
        if (touchNode.name == "start")
        {
            ...
            let transitionTpe = SKTransition.flipHorizontal(withDuration: 1.0)
            view?.presentScene(gameOverScene, transition: transitionTpe)
        }
